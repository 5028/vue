            ...
            <div class="content mar_20">
                <div class="two_bg">
                    ...
                    <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr v-for="show in cade">
                            <td>
                                <div class="c_s_img"><img src="../assets/images/c_1.jpg" width="73" height="73" /></div>
                                {{show[0].name}}
                            </td>
                            <td align="center">{{show[0].attr_name}}</td>
                            <td align="center">{{show[0].newber}}</td>
                            <td align="center" style="color:#ff4e00;">￥{{show[0].price}}</td>
                    ...
                    <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0" v-for="area in address">
                        <tr>
                            <td class="p_td" width="160">商品名称</td>
                            <td width="395">{{area.u_id}}</td>
                            <td class="p_td" width="160">姓名</td>
                            <td width="395">{{area.name}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="p_td">手机</td>
                            <td>{{area.phone}}</td>
                            <td class="p_td">具体地址</td>
                            <td>{{area.de_address}}</td>
                        </tr>
                    </table>
                    ...
                    <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr height="70">
                            <td align="right">
                                <b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">{{totalp}}</span></b>
                            </td>
                        </tr>
                        <tr height="70">
                            <td align="right"><a v-on:click="addorder()"><img src="../assets/images/btn_sure.gif" /></a></td>
                        </tr>
                    </table>
    ...
    export default {
        data () {
            return {
                ...
                buycar_id:localStorage.getItem("buycar_id"),
                cade:'',
                address:'',
                totalp:''
            }
        ...
        mounted () {
            var _this=this
            var totalp=0
            //console.log(localStorage.getItem("buycar_id"));
            axios.post(this.url+"auth/buycar_two",{
                id:localStorage.getItem("buycar_id"),
                token: localStorage.getItem("token"),
            })
                .then(res => {
                    _this.cade = res.data.data.key
                        //console.log(res.data.data.key)
                    res.data.data.key.forEach(function (val) {
                        if (val!=''){
                            totalp+=val[0].newber * val[0].price
                        }
                    })
                    //console.log(totalp)
                    this.totalp=totalp
            ...
            axios.post(this.url+"auth/buycar_two1",{
                token: localStorage.getItem("token"),
            })
                .then(res => {
        ...
        methods : {
            addorder() {
                //发送请求
                console.log(this.cade)
                console.log(this.address)
                console.log(this.totalp)
                var _this=this
                axios.post(this.url+"auth/addorder", {
                    cade:this.cade,
                    ...
                    .then(response => (
                        _this.jian = response.data.data,
                            _this.jian = response.data.price,
                            console.log(response.data.data),
                        location.href="http://localhost/blog/public/api/index?id="+response.data.data+"&price="+this.jian))
            }
        }
