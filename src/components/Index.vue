...
<div>
  ...
  <div class="soubg">
    <div class="sou">
      ...
      <!--End 所在收货地区 End-->
      <span class="fr">
        	<span class="fl" v-if="name === ''"><a style="color: red" ><router-link to="/ylogin">你好，请先登陆</router-link></a>&nbsp;</span>
        	<span class="fl" v-else>用户:&nbsp;<a><router-link to="/Member_user" style="color: red" >{{name}}</router-link>&nbsp;&nbsp;<button @click="logout()">退出</button> </a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|<a href="#"><router-link to="/BuyCar" style="color: red" >购物车</router-link></a>&nbsp;|</span>
        <span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
  ...
  <div class="top">
    ...
    <div class="i_car">
      ...
      <div class="car_bg">
        <!--Begin 购物车未登录 Begin-->
        <div class="un_login" v-if="name == ''">还未登录！<a href="Login.html" style="color:#ff4e00;">马上登录</a></div>
        <!--End 购物车未登录 End-->
        <div v-else>
          <!--Begin 购物车已登录 Begin-->
          <ul class="cars">
            ...
            <li v-for="cates in cate">
              ...
              <div class="zj">
                <div class="zj_l">
                  <div class="zj_l_c">
<!--                    <h2>零食 / 糖果 / 巧克力</h2>-->
                    <a href="#" v-for="son in cates.son">{{son.name}}|</a>
                  </div>
                </div>
              </div>
            </li>
  ...
  <div class="i_bg bg_color">
    ...
    <!--End 限时特卖 End-->
  <div v-for="showss in floorshow" >
    <!--Begin 进口 生鲜 Begin-->
    <div>
      <div class="i_t mar_10"  >
        <span class="floor_num"></span>
        <span class="fl">{{showss.name}}</span>
        <span class="i_mores fr"><a href="#">进口咖啡</a>&nbsp; &nbsp; &nbsp; <a href="#">进口酒</a>&nbsp; &nbsp; &nbsp; <a href="#">进口母婴</a>&nbsp; &nbsp; &nbsp; <a href="#">新鲜蔬菜</a>&nbsp; &nbsp; &nbsp; <a href="#">新鲜水果</a></span>
      </div>
      <div class="content">
        <div class="fresh_mid">
          <ul>
            <li v-for="msadd in floor" v-if="msadd.f_id === showss.id">
              <router-link :to="'/product?id='+msadd.fs_id">
              <div class="name"><a style="color: red" >{{msadd.fs_show}}</a></div>
              <div class="price">
...
<script>
  export default {
    ...
    mounted () {
      var _this=this
      axios.post(this.url+"shop")
        .then(response => (_this.cate = response.data.data))
        .catch(function (error) {
          console.log(error);
        });
      axios.post(this.url+"floor")
        .then(response => (this.floor = response.data.data))
        .catch(function (error) {
          console.log(error)
        });
      axios.post(this.url+"floorshow")
        .then(response => (this.floorshow = response.data.data))
        .catch(function (error) {
          console.log(error)
        })
