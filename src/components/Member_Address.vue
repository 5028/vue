...
<div>
    <div class="soubg">
        <div class="sou">
            ...
            <!--End 所在收货地区 End-->
            <span class="fr">
        	<span class="fl"><a href="Login.html">{{name}}</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
        ...
        <div class="m_content">
            <div class="m_left">
                ...
                <div class="left_m">
                    ...
                    <ul>
                        <li><router-link to="/Member_user" style="color: red" >用户信息</router-link></li>
            ...
            <div class="m_right">
                ...
                <div class="address" v-for="area in cade">
                    <div class="a_close"><a href="#"><img src="../assets/images/a_close.png" /></a></div>
                    <table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="2" style="font-size:14px; color:#ff4e00;">{{area.id}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td v-if="area.default==1">是</td>
                            <td v-else>否</td>
                        </tr>
                    </table>

                    <p align="right" v-if="area.default_area==1">
                        <a href="#" style="color:#ff4e00;">已经设为默认</a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="#" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp;
                    </p>
                    <p align="right" v-else>
                        <a href="#" style="color:blue;">点击设为默认</a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="#" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp;
                    </p>
...
<script>
    export default {
        ...
        mounted () {
            var _this=this
            //发送请求
            axios.post(this.url+"auth/address_show",{
                token: localStorage.getItem("token"),
            })
            //这边是返回结果
                .then(res => {
                    _this.cade = res.data.data,
