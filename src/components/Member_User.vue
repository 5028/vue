    ...
    <div>
        <div class="soubg">
            ...
            <span class="s_city">
                ...
                <!--End 所在收货地区 End-->
                <span class="fr">
        	<span class="fl"><a href="#">{{name}}</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
        ...
        <div class="i_bg bg_color">
            ...
            <div class="m_content">
                <div class="m_left">
                    ...
                    <div class="left_m">
                        ...
                        <ul>
                            ...
                            <li><router-link to="/Member_address" style="color: red" >收货地址</router-link>
                            </li>
                            <li><a href="#">缺货登记</a></li>
                            <li><a href="#">跟踪订单</a></li>
                        </ul>
                ...
                <div class="m_right">
                    ...
                    <div class="mem_tit">
                        <a ><input type="button" value="添加地址" v-on:click="add_area"></a>
                    </div>
                    <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="135" align="right">配送地区</td>
                            <td colspan="3" style="font-family:'宋体';">
                                <select class="jj" name="province" v-on:change="area_show" id="province">
                                    <option v-for="area in cade" value="" v-bind:value="area.area_id" >{{area.area_name}}</option>
                                </select>

                                <select class="jj" name="city" v-on:change="area_show1" id="city">
                                    <option v-for="area1 in show1" value="" v-bind:value="area1.area_id" >{{area1.area_name}}</option>
                                </select>

                                <select class="jj" name="area" id="area">
                                    <option v-for="area2 in show2" value="" v-bind:value="area2.area_id" >{{area2.area_name}}</option>
                                </select>
                                （必填）
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="font-family:'宋体';"><input type="text" v-bind:value="1" id="name" class="add_ipt" />（必填）</td>
                            <td align="right">详细地址</td>
                            <td style="font-family:'宋体';"><input type="text" v-bind:value="1" id="address" class="add_ipt" />（必填）</td>
                        </tr>
                        <tr>
                            <td align="right">手机</td>
                            <td style="font-family:'宋体';"><input type="text" v-bind:value="1" id="phone" class="add_ipt" />（必填）</td>
                            <td align="right">邮政编码</td>
                            <td style="font-family:'宋体';"><input type="text" v-bind:value="1" id="postal_code" class="add_ipt" /></td>
                        </tr>
                    </table>
    ...
    export default {
        ...
        mounted () {
            var _this=this
                ...
                axios.post(this.url+"auth/province",{
                    token: localStorage.getItem("token"),
                })
                //这边是返回结果
                    .then(res => {
                        _this.cade = res.data.data.data,
        ...
        methods : {
            area_show() {
                ...
                console.log(id)
                var _this=this
                axios.post(this.url+"auth/area_show", {
                    area_id:id,
                    token: localStorage.getItem("token"),
                })
                    .then(response => (
                        _this.show1 = response.data.data.data,
            ...
            area_show1() {
                ...
                axios.post(this.url+"auth/area_show", {
                    ...
                    .then(response => (
                        _this.show2 = response.data.data.data,
                            console.log(response.data.data.data)
                    ))
                    .catch(function (error) {
                        console.log(error);
            ...
            add_area() {
                ...
                var _this=this
                axios.post(this.url+"auth/addarea", {
                    province:province,
                    city:city,
                    area:area,
                    name:name,
                    ...
                    .then(response => (
                        _this.show3 = response.data.data,
